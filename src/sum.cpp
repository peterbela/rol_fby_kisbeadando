...
public:
    SumData(): Node("sum_node"), count_(0)
    {
        ...
        sub1_ = this->create_subscription<std_msgs::msg::Float32>("tangent", 10, std::bind(&SumData::tangent_callback, this, _1));
...
private:
    void timer_callback()
    {
        ...
        message_sum.data = tangent_ + rand_ + in_;
        pub1_->publish(message_sum);
    }

    void tangent_callback(const std_msgs::msg::Float32::SharedPtr msg)
    {
        tangent_ = msg->data;
    }
